            ...
            <div className="mainfut">
                <div className="topfut">
                    <div className="leftfut">
                        ...
                        <section> 
                            <a href="https://vk.com/melekhov_art" target="_blank"><img src={vk} alt="VK" /></a>
                            <a href="https://dzen.ru/id/69b30d967c578d071b889373?share_to=link" target="_blank"><img src={yandex} alt="Yandex" /></a>
                            <a href="https://max.ru/join/acAzseAAZ1_PBeI6ETX2a7b0WXLoRST3cnHT32Ke8r8" target="_blank"><img src={max} alt="Max" /></a>
                        </section>
                    </div>
                ...
                <div className="bottomfut">
                    <p>© 2026 Олег Александрович Мелехов. Все права защищены. 
